function [theta, loglike] = bayes_sl_ma_acf_warton(y,M,n,cov_rw,start,K,gamma)
% MCMC shrinkage BSL for MA(2) model
...
% gamma - shrinkage parameter for estimating covariance matrix of summaries
